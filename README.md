...
```jsx
wget https://raw.githubusercontent.com/sanakstore/Custom-Windows-Server-Image/main/windows-server-autoinstaller.sh
```
...
Buka browser, download dengan mengakses VPSnya Yang Sebelumya Kalian Install Windows. Ubah yyy dengan ip kalian, xxx untuk versi Windows Server yang kalian pilih
